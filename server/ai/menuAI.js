...
function composeMenu(params) {
    return __awaiter(this, void 0, void 0, function () {
        var model, prompt, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    prompt = "\nYou are a Michelin-star chef.\n\nIngredients:\n".concat(params.ingredients.join(', '), "\n\nLanguage: ").concat(params.language, "\n\nReturn STRICT JSON:\n{\n  \"title\": \"\",\n  \"description\": \"\",\n  \"ingredients\": [],\n  \"instructions\": [],\n  \"prepTime\": \"\",\n  \"servings\": 2\n}\n");
                    return [4 /*yield*/, model.generateContent(prompt)];
                case 1:
                    res = _a.sent();
                    return [2 /*return*/, JSON.parse(res.response.text())];
            }
        });
    });
}
